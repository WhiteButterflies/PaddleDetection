        ...
        while (not framequeue.empty()):
            ...
            if self.modebase["idbased"] or self.modebase["skeletonbased"]:
                ...
                if self.with_human_attr:
                    ...
                    pass
                    attr_color = [ self.detect_red_upper_body(item,threshold=0.1) for item in crop_input]
...
class QueryGUI(threading.Thread):
    def __init__(self, pipeline):
        ...
        self.logo_paths = (
            "/home/lisushang/PycharmProjects/PaddleDetection/liu/tjut.png",
            "/home/lisushang/PycharmProjects/PaddleDetection/liu/jjzx.png"
        )
        self.logo_images = []
        self.running = True
        self.root = None
